...
#define LED_RED PIN_LED   // alias: single LED board
...
// extra center pins (clockwise from bottom left, viewed from bottom side of
// board) only using through-hole pins P0.05 (AIN3) is a surface mount that
// isn't broken out
